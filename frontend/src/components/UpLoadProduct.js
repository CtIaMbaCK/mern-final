...
const UpLoadProduct = ({
    ...
    return (
        <div className='absolute w-full h-full z-10 flex justify-center items-center  top-0 left-0 bg-slate-300 bg-opacity-35' >
            <div className=' bg-white mx-auto p-4 w-full max-w-3xl h-full max-h-[80%] shadow-md relative pb-16 overflow-hidden'>
                ...
                <form className='grid p-4 gap-2 overflow-y-scroll h-full ' onSubmit={handleSubmit}>
                    ...
                    <button className='px-4 py-2 bg-sky-500 text-white mb-6 mt-6'>Upload Prodcut</button>
                </form>
            </div>
